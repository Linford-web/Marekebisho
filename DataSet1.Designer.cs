...
namespace Prison {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StaffDataTable : global::System.Data.TypedTableBase<StaffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StaffRow AddStaffRow(int Employee_Id, string password) {
...
namespace Prison.DataSet1TableAdapters {
    ...
    public partial class StaffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Staff] WHERE (([Employee_Id] = @Original_Employee_Id))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Staff] SET [Employee_Id] = @Employee_Id, [password] = @password WHERE (([" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["PrisonConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Employee_Id, password\r\nFROM            Staff\r\nWHERE        (Employe" +
                "e_Id = @Employee_Id) AND (password = @password)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Employee_Id", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Employee_Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].CommandText = "SELECT        Employee_Id, password, role_id\r\nFROM            Staff\r\nWHERE       " +
                " (Employee_Id = @Employee_Id) AND (password = @password) AND (role_id = @role_id" +
                ")";
        ...
        public virtual int Fill(DataSet1.StaffDataTable dataTable, int Employee_Id, string password) {
        ...
        public virtual DataSet1.StaffDataTable GetData(int Employee_Id, string password) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Employee_Id));
            if ((password == null)) {
                throw new global::System.ArgumentNullException("password");
        ...
        public virtual int FillBy(DataSet1.StaffDataTable dataTable, int Employee_Id, string password, int role_id) {
            ...
            this.Adapter.SelectCommand.Parameters[2].Value = ((int)(role_id));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual DataSet1.StaffDataTable GetDataBy(int Employee_Id, string password, int role_id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Employee_Id));
            if ((password == null)) {
                throw new global::System.ArgumentNullException("password");
        ...
        public virtual int Update(int Employee_Id, string password, int Original_Employee_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, int Original_Employee_Id) {
            return this.Update(Original_Employee_Id, password, Original_Employee_Id);
        }
    }
